...
public interface IUserService
{
    ...
    Task<Result<PagedResult<UserDto>>> GetPagedAsync(int page, int pageSize, string? searchTerm = null, bool? isActive = null, AssetManagement.Domain.Enums.UserRole? role = null);
